      ...
      <div className="bg-white shadow-md rounded-lg p-6 flex flex-col max-w-xl mx-auto h-[500px]">
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <input
            ...
            className="w-full flex-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d42755] transition duration-200 ease-in-out"
            placeholder="Type a message..."
          />
          <button
            onClick={handleSend}
            className="w-full sm:w-auto px-4 py-2 bg-[#d42755] text-white rounded-lg hover:bg-[#b51d48] transition duration-200 ease-in-out"
